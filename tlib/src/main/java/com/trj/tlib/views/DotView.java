...
public class DotView extends TBaseView {
    ...
    public void initXmlAttribute(AttributeSet attrs) {
        ...
        dotColor = a.getColor(R.styleable.DotView_dotview_color, context.getResources().getColor(R.color.colorAccent));
        dotColorLine = a.getColor(R.styleable.DotView_dotview_color_line, context.getResources().getColor(R.color.colorAccent));
        a.recycle();
    }
    ...
    public void initAttribute() {
        ...
        dotHollowWidth = 2;
        dotLineWidth = 1;
        dotColor = context.getResources().getColor(R.color.colorAccent);
        dotColorLine = context.getResources().getColor(R.color.colorAccent);
    }
