...
public class RoundTextView extends TextView {
    ...
    public RoundTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        colorBg = a.getColor(R.styleable.RoundTextView_rtextview_bg_color, context.getResources().getColor(R.color.transparent));
        colorProgress = a.getColor(R.styleable.RoundTextView_rtextview_progress_color, context.getResources().getColor(R.color.transparent));
